          ...
          <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] p-8 text-center">
            ...
            <div className="border-t border-white/[0.06] pt-6 mt-6">
              ...
              <p className="text-xs text-zinc-500 mb-4">
                Enter it below to skip the waitlist and get immediate access.
              </p>
              ...
              {!applied ? (
                <form onSubmit={handleApplyCode} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 h-11 px-4 rounded-xl bg-white/[0.05] border border-white/[0.08] text-white placeholder-zinc-500 outline-none focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/20 transition-all text-sm font-mono"
                  />
                  <button
                    type="submit"
                    disabled={applyLoading || !inviteCode.trim()}
